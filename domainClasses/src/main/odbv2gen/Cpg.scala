...
class CpgGeneratedNodeStarters(val wrappedGraph: Cpg) extends AnyVal {
  ...
  def annotationLiteral: Iterator[nodes.AnnotationLiteral] =
    wrappedGraph.graph.nodes(1).asInstanceOf[Iterator[nodes.AnnotationLiteral]]
  ...
  def arrayInitializer: Iterator[nodes.ArrayInitializer] =
    wrappedGraph.graph.nodes(4).asInstanceOf[Iterator[nodes.ArrayInitializer]]
  ...
  def closureBinding: Iterator[nodes.ClosureBinding] =
    wrappedGraph.graph.nodes(8).asInstanceOf[Iterator[nodes.ClosureBinding]]
  ...
  def controlStructure: Iterator[nodes.ControlStructure] =
    wrappedGraph.graph.nodes(11).asInstanceOf[Iterator[nodes.ControlStructure]]
  ...
  def fieldIdentifier: Iterator[nodes.FieldIdentifier] =
    wrappedGraph.graph.nodes(13).asInstanceOf[Iterator[nodes.FieldIdentifier]]
  ...
  def keyValuePair: Iterator[nodes.KeyValuePair] =
    wrappedGraph.graph.nodes(20).asInstanceOf[Iterator[nodes.KeyValuePair]]
  ...
  def methodParameterIn: Iterator[nodes.MethodParameterIn] =
    wrappedGraph.graph.nodes(27).asInstanceOf[Iterator[nodes.MethodParameterIn]]
  def methodParameterOut: Iterator[nodes.MethodParameterOut] =
    wrappedGraph.graph.nodes(28).asInstanceOf[Iterator[nodes.MethodParameterOut]]
  ...
  def methodReturn: Iterator[nodes.MethodReturn] =
    wrappedGraph.graph.nodes(30).asInstanceOf[Iterator[nodes.MethodReturn]]
  ...
  def namespaceBlock: Iterator[nodes.NamespaceBlock] =
    wrappedGraph.graph.nodes(33).asInstanceOf[Iterator[nodes.NamespaceBlock]]
  ...
  def typeArgument: Iterator[nodes.TypeArgument] =
    wrappedGraph.graph.nodes(39).asInstanceOf[Iterator[nodes.TypeArgument]]
  ...
  def typeParameter: Iterator[nodes.TypeParameter] =
    wrappedGraph.graph.nodes(41).asInstanceOf[Iterator[nodes.TypeParameter]]
