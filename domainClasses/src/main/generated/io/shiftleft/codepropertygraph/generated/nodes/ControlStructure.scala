...
class ControlStructure(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to JUMP_LABEL via AST OUT edge.
    */
  def jumpLabelViaAstOut: overflowdb.traversal.Traversal[JumpLabel] = get().jumpLabelViaAstOut

  @deprecated("please use `jumpLabelViaAstOut`", "June 2024")
  def _jumpLabelViaAstOut = jumpLabelViaAstOut
  ...
  /** Traverse to BLOCK via CONDITION OUT edge.
    */
  def blockViaConditionOut: overflowdb.traversal.Traversal[Block] = get().blockViaConditionOut

  @deprecated("please use `blockViaConditionOut`", "June 2024")
  def _blockViaConditionOut = blockViaConditionOut

  /** Traverse to CALL via CONDITION OUT edge.
    */
  def callViaConditionOut: overflowdb.traversal.Traversal[Call] = get().callViaConditionOut

  @deprecated("please use `callViaConditionOut`", "June 2024")
  def _callViaConditionOut = callViaConditionOut

  /** Traverse to CONTROL_STRUCTURE via CONDITION OUT edge.
    */
  def controlStructureViaConditionOut: overflowdb.traversal.Traversal[ControlStructure] =
    get().controlStructureViaConditionOut

  @deprecated("please use `controlStructureViaConditionOut`", "June 2024")
  def _controlStructureViaConditionOut = controlStructureViaConditionOut

  /** Traverse to IDENTIFIER via CONDITION OUT edge.
    */
  def identifierViaConditionOut: overflowdb.traversal.Traversal[Identifier] = get().identifierViaConditionOut

  @deprecated("please use `identifierViaConditionOut`", "June 2024")
  def _identifierViaConditionOut = identifierViaConditionOut

  /** Traverse to JUMP_TARGET via CONDITION OUT edge.
    */
  def jumpTargetViaConditionOut: overflowdb.traversal.Traversal[JumpTarget] = get().jumpTargetViaConditionOut

  @deprecated("please use `jumpTargetViaConditionOut`", "June 2024")
  def _jumpTargetViaConditionOut = jumpTargetViaConditionOut

  /** Traverse to LITERAL via CONDITION OUT edge.
    */
  def literalViaConditionOut: overflowdb.traversal.Traversal[Literal] = get().literalViaConditionOut

  @deprecated("please use `literalViaConditionOut`", "June 2024")
  def _literalViaConditionOut = literalViaConditionOut

  /** Traverse to METHOD_REF via CONDITION OUT edge.
    */
  def methodRefViaConditionOut: overflowdb.traversal.Traversal[MethodRef] = get().methodRefViaConditionOut

  @deprecated("please use `methodRefViaConditionOut`", "June 2024")
  def _methodRefViaConditionOut = methodRefViaConditionOut

  /** Traverse to RETURN via CONDITION OUT edge.
    */
  def returnViaConditionOut: overflowdb.traversal.Traversal[Return] = get().returnViaConditionOut

  @deprecated("please use `returnViaConditionOut`", "June 2024")
  def _returnViaConditionOut = returnViaConditionOut

  /** Traverse to TYPE_REF via CONDITION OUT edge.
    */
  def typeRefViaConditionOut: overflowdb.traversal.Traversal[TypeRef] = get().typeRefViaConditionOut

  @deprecated("please use `typeRefViaConditionOut`", "June 2024")
  def _typeRefViaConditionOut = typeRefViaConditionOut

  /** Traverse to UNKNOWN via CONDITION OUT edge.
    */
  def unknownViaConditionOut: overflowdb.traversal.Traversal[Unknown] = get().unknownViaConditionOut

  @deprecated("please use `unknownViaConditionOut`", "June 2024")
  def _unknownViaConditionOut = unknownViaConditionOut
...
class ControlStructureDb(ref: NodeRef[NodeDb])
  ...
  def jumpLabelViaAstOut: overflowdb.traversal.Traversal[JumpLabel] = astOut.collectAll[JumpLabel]
  @deprecated("please use `jumpTargetViaAstOut`", "June 2024")
  def _jumpTargetViaAstOut = jumpTargetViaAstOut
  ...
  def blockViaConditionOut: overflowdb.traversal.Traversal[Block] = conditionOut.collectAll[Block]
  @deprecated("please use `callViaConditionOut`", "June 2024")
  def _callViaConditionOut = callViaConditionOut

  def callViaConditionOut: overflowdb.traversal.Traversal[Call] = conditionOut.collectAll[Call]
  @deprecated("please use `controlStructureViaConditionOut`", "June 2024")
  def _controlStructureViaConditionOut = controlStructureViaConditionOut
  ...
  def identifierViaConditionOut: overflowdb.traversal.Traversal[Identifier] = conditionOut.collectAll[Identifier]
  @deprecated("please use `jumpTargetViaConditionOut`", "June 2024")
  def _jumpTargetViaConditionOut = jumpTargetViaConditionOut

  def jumpTargetViaConditionOut: overflowdb.traversal.Traversal[JumpTarget] = conditionOut.collectAll[JumpTarget]
  @deprecated("please use `literalViaConditionOut`", "June 2024")
  def _literalViaConditionOut = literalViaConditionOut

  def literalViaConditionOut: overflowdb.traversal.Traversal[Literal] = conditionOut.collectAll[Literal]
  @deprecated("please use `methodRefViaConditionOut`", "June 2024")
  def _methodRefViaConditionOut = methodRefViaConditionOut

  def methodRefViaConditionOut: overflowdb.traversal.Traversal[MethodRef] = conditionOut.collectAll[MethodRef]
  @deprecated("please use `returnViaConditionOut`", "June 2024")
  def _returnViaConditionOut = returnViaConditionOut

  def returnViaConditionOut: overflowdb.traversal.Traversal[Return] = conditionOut.collectAll[Return]
  @deprecated("please use `typeRefViaConditionOut`", "June 2024")
  def _typeRefViaConditionOut = typeRefViaConditionOut

  def typeRefViaConditionOut: overflowdb.traversal.Traversal[TypeRef] = conditionOut.collectAll[TypeRef]
  @deprecated("please use `unknownViaConditionOut`", "June 2024")
  def _unknownViaConditionOut = unknownViaConditionOut

  def unknownViaConditionOut: overflowdb.traversal.Traversal[Unknown] = conditionOut.collectAll[Unknown]
