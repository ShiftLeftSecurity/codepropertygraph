...
object NewTypeParameter {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_TypeParameter_offset extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_TypeParameter_offsetEnd extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewTypeParameter extends NewNode(nodeKind = 40) with TypeParameterBase with AstNodeNew {
