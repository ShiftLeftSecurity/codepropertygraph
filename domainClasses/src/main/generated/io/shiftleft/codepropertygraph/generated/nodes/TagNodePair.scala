...
class TagNodePair(graph_4762: flatgraph.Graph, seq_4762: Int)
  ...
  def node: StoredNode = flatgraph.Accessors.getNodePropertySingle(graph, nodeKind, 52, seq, null: StoredNode)
  def tag: Tag         = flatgraph.Accessors.getNodePropertySingle(graph, nodeKind, 53, seq, null: Tag)
