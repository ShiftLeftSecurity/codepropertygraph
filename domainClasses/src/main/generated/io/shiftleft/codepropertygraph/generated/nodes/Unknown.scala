...
trait UnknownEMT extends AnyRef with ExpressionEMT with HasContainedRefEMT with HasDynamicTypeHintFullNameEMT with HasParserTypeNameEMT with HasPossibleTypesEMT with HasTypeFullNameEMT
...
val ContainedRef = io.shiftleft.codepropertygraph.generated.PropertyNames.CONTAINED_REF
...
class Unknown(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 43.toShort , seq_4762) with UnknownBase with Expression with StaticType[UnknownEMT] {
