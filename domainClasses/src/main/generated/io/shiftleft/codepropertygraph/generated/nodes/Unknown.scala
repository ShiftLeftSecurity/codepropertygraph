...
/** * NODE PROPERTIES:
  ...
  *
  * ▸ ContainedRef (String); Cardinality `one` (mandatory with default value `<empty>`); References to other nodes. This
  * is not a real property; it exists here for the sake of proto serialization only. valueType and cardinality are
  * meaningless.
  *
...
class Unknown(graph_4762: flatgraph.Graph, seq_4762: Int)
    extends StoredNode(graph_4762, 42, seq_4762)
    with UnknownBase
    with Expression
