...
object NewAnnotation {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_Annotation_argumentLabel extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewAnnotation extends NewNode(nodeKind = 0) with AnnotationBase with ExpressionNew {
