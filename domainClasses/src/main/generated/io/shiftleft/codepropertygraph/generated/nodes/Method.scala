...
object Method {
  ...
  object Properties {
    ...
    val GenericSignature =
      flatgraph.SinglePropertyKey[String](kind = 21, name = "GENERIC_SIGNATURE", default = "<empty>")
...
class NewMethod extends NewNode(25.toShort) with MethodBase with AstNodeNew with CfgNodeNew with DeclarationNew {
