...
object NewNamespaceBlock {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_NamespaceBlock_offset extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_NamespaceBlock_offsetEnd extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewNamespaceBlock extends NewNode(32.toShort) with NamespaceBlockBase with AstNodeNew {
