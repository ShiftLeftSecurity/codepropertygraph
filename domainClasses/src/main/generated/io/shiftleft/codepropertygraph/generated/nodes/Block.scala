...
class Block(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to BLOCK via REACHING_DEF OUT edge.
    */
  def _blockViaReachingDefOut: overflowdb.traversal.Traversal[Block] = get()._blockViaReachingDefOut
...
class BlockDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with BlockBase {
  ...
  private var _argumentIndex: scala.Int                    = Block.PropertyDefaults.ArgumentIndex
  ...
  def astOut: Iterator[AstNode]                              = createAdjacentNodeScalaIteratorByOffSet[AstNode](4)
  override def _astOut                                       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](4)
  ...
  def argumentOut: Iterator[TemplateDom] = createAdjacentNodeScalaIteratorByOffSet[TemplateDom](6)
  override def _argumentOut              = createAdjacentNodeScalaIteratorByOffSet[StoredNode](6)

  def cdgOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](7)
  override def _cdgOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](7)
  ...
  def astIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](13)
  ...
  def reachingDefIn: Iterator[Expression] = createAdjacentNodeScalaIteratorByOffSet[Expression](14)
  ...
  override def fromNewNode(newNode: NewNode, mapping: NewNode => StoredNode): Unit = {
    ...
    this._argumentName = newNode.asInstanceOf[NewBlock].argumentName.orNull
    this._code = newNode.asInstanceOf[NewBlock].code
    this._columnNumber = newNode.asInstanceOf[NewBlock].columnNumber.orNull
