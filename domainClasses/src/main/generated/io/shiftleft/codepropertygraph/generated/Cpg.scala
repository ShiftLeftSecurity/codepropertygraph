...
def annotationParameterAssign: Iterator[nodes.AnnotationParameterAssign] = wrappedCpg.graph._nodes(3).asInstanceOf[Iterator[nodes.AnnotationParameterAssign]]
...
def closureBinding: Iterator[nodes.ClosureBinding] = wrappedCpg.graph._nodes(8).asInstanceOf[Iterator[nodes.ClosureBinding]]
...
def controlStructure: Iterator[nodes.ControlStructure] = wrappedCpg.graph._nodes(11).asInstanceOf[Iterator[nodes.ControlStructure]]
def dependency: Iterator[nodes.Dependency] = wrappedCpg.graph._nodes(12).asInstanceOf[Iterator[nodes.Dependency]]
def fieldIdentifier: Iterator[nodes.FieldIdentifier] = wrappedCpg.graph._nodes(13).asInstanceOf[Iterator[nodes.FieldIdentifier]]
...
def keyValuePair: Iterator[nodes.KeyValuePair] = wrappedCpg.graph._nodes(20).asInstanceOf[Iterator[nodes.KeyValuePair]]
...
def methodParameterIn: Iterator[nodes.MethodParameterIn] = wrappedCpg.graph._nodes(27).asInstanceOf[Iterator[nodes.MethodParameterIn]]
def methodParameterOut: Iterator[nodes.MethodParameterOut] = wrappedCpg.graph._nodes(28).asInstanceOf[Iterator[nodes.MethodParameterOut]]
def methodRef: Iterator[nodes.MethodRef] = wrappedCpg.graph._nodes(29).asInstanceOf[Iterator[nodes.MethodRef]]
def methodReturn: Iterator[nodes.MethodReturn] = wrappedCpg.graph._nodes(30).asInstanceOf[Iterator[nodes.MethodReturn]]
...
def namespaceBlock: Iterator[nodes.NamespaceBlock] = wrappedCpg.graph._nodes(33).asInstanceOf[Iterator[nodes.NamespaceBlock]]
...
def typeArgument: Iterator[nodes.TypeArgument] = wrappedCpg.graph._nodes(39).asInstanceOf[Iterator[nodes.TypeArgument]]
def typeDecl: Iterator[nodes.TypeDecl] = wrappedCpg.graph._nodes(40).asInstanceOf[Iterator[nodes.TypeDecl]]
def typeParameter: Iterator[nodes.TypeParameter] = wrappedCpg.graph._nodes(41).asInstanceOf[Iterator[nodes.TypeParameter]]
