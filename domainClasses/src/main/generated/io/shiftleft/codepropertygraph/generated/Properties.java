...
public static final overflowdb.PropertyKey<scala.Int> ARGUMENT_INDEX = new overflowdb.PropertyKey<>("ARGUMENT_INDEX");
...
this field is unset. */
public static final overflowdb.PropertyKey<String> ARGUMENT_NAME = new overflowdb.PropertyKey<>("ARGUMENT_NAME");
...
public static final overflowdb.PropertyKey<String> IMPORTED_AS = new overflowdb.PropertyKey<>("IMPORTED_AS");
...
public static final overflowdb.PropertyKey<String> IMPORTED_ENTITY = new overflowdb.PropertyKey<>("IMPORTED_ENTITY");
...
public static final overflowdb.PropertyKey<scala.collection.IndexedSeq<String>> INHERITS_FROM_TYPE_FULL_NAME = new overflowdb.PropertyKey<>("INHERITS_FROM_TYPE_FULL_NAME");
...
public static final overflowdb.PropertyKey<Boolean> IS_EXTERNAL = new overflowdb.PropertyKey<>("IS_EXTERNAL");
...
public static final overflowdb.PropertyKey<Boolean> IS_VARIADIC = new overflowdb.PropertyKey<>("IS_VARIADIC");
...
order of 0. */
public static final overflowdb.PropertyKey<scala.Int> ORDER = new overflowdb.PropertyKey<>("ORDER");
...
between each other. */
public static final overflowdb.PropertyKey<scala.collection.IndexedSeq<String>> OVERLAYS = new overflowdb.PropertyKey<>("OVERLAYS");
