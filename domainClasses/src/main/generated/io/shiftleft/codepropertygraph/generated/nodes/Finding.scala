...
class Finding(graph_4762: flatgraph.Graph, seq_4762: Int)
  ...
  def evidence: IndexedSeq[StoredNode] =
    flatgraph.Accessors.getNodePropertyMulti[StoredNode](graph, nodeKind = nodeKind, propertyKind = 53, seq = seq)
  def keyValuePairs: IndexedSeq[KeyValuePair] =
    flatgraph.Accessors.getNodePropertyMulti[KeyValuePair](graph, nodeKind = nodeKind, propertyKind = 54, seq = seq)
