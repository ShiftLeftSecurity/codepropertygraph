...
class ReturnDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with ReturnBase {
  ...
  def astOut: Iterator[CfgNode]                              = createAdjacentNodeScalaIteratorByOffSet[CfgNode](0)
  ...
  def cfgOut: Iterator[MethodReturn] = createAdjacentNodeScalaIteratorByOffSet[MethodReturn](4)
  ...
  def argumentOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](6)
  ...
  def reachingDefIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](10)
  ...
  def dominateIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](12)
  override def _dominateIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](12)
  ...
  def argumentIn: Iterator[Return]         = createAdjacentNodeScalaIteratorByOffSet[Return](17)
  override def _argumentIn                 = createAdjacentNodeScalaIteratorByOffSet[StoredNode](17)
