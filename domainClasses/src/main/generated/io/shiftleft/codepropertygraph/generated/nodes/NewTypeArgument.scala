...
object NewTypeArgument {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_TypeArgument_offset extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_TypeArgument_offsetEnd extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewTypeArgument extends NewNode(nodeKind = 38) with TypeArgumentBase with AstNodeNew {
