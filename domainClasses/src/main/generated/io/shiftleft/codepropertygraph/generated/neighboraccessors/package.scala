...
implicit def accessNeighborsForAnnotationTraversal(traversal: IterableOnce[nodes.Annotation]): AccessNeighborsForAnnotationTraversal =
...
implicit def accessNeighborsForAnnotationLiteralTraversal(traversal: IterableOnce[nodes.AnnotationLiteral]): AccessNeighborsForAnnotationLiteralTraversal =
...
implicit def accessNeighborsForAnnotationParameterTraversal(traversal: IterableOnce[nodes.AnnotationParameter]): AccessNeighborsForAnnotationParameterTraversal =
  new AccessNeighborsForAnnotationParameterTraversal(traversal.iterator)

implicit def accessNeighborsForAnnotationParameterAssign(node: nodes.AnnotationParameterAssign): AccessNeighborsForAnnotationParameterAssign =
  new AccessNeighborsForAnnotationParameterAssign(node)

implicit def accessNeighborsForAnnotationParameterAssignTraversal(traversal: IterableOnce[nodes.AnnotationParameterAssign]): AccessNeighborsForAnnotationParameterAssignTraversal =
...
implicit def accessNeighborsForArrayInitializerTraversal(traversal: IterableOnce[nodes.ArrayInitializer]): AccessNeighborsForArrayInitializerTraversal =
...
implicit def accessNeighborsForBindingTraversal(traversal: IterableOnce[nodes.Binding]): AccessNeighborsForBindingTraversal =
...
implicit def accessNeighborsForBlockTraversal(traversal: IterableOnce[nodes.Block]): AccessNeighborsForBlockTraversal =
...
implicit def accessNeighborsForClosureBindingTraversal(traversal: IterableOnce[nodes.ClosureBinding]): AccessNeighborsForClosureBindingTraversal =
...
implicit def accessNeighborsForCommentTraversal(traversal: IterableOnce[nodes.Comment]): AccessNeighborsForCommentTraversal =
...
implicit def accessNeighborsForControlStructureTraversal(traversal: IterableOnce[nodes.ControlStructure]): AccessNeighborsForControlStructureTraversal =
...
implicit def accessNeighborsForDependencyTraversal(traversal: IterableOnce[nodes.Dependency]): AccessNeighborsForDependencyTraversal =
...
implicit def accessNeighborsForFieldIdentifierTraversal(traversal: IterableOnce[nodes.FieldIdentifier]): AccessNeighborsForFieldIdentifierTraversal =
...
implicit def accessNeighborsForIdentifierTraversal(traversal: IterableOnce[nodes.Identifier]): AccessNeighborsForIdentifierTraversal =
...
implicit def accessNeighborsForImportTraversal(traversal: IterableOnce[nodes.Import]): AccessNeighborsForImportTraversal =
...
implicit def accessNeighborsForJumpLabelTraversal(traversal: IterableOnce[nodes.JumpLabel]): AccessNeighborsForJumpLabelTraversal =
...
implicit def accessNeighborsForJumpTargetTraversal(traversal: IterableOnce[nodes.JumpTarget]): AccessNeighborsForJumpTargetTraversal =
...
implicit def accessNeighborsForLiteralTraversal(traversal: IterableOnce[nodes.Literal]): AccessNeighborsForLiteralTraversal =
...
implicit def accessNeighborsForLocalTraversal(traversal: IterableOnce[nodes.Local]): AccessNeighborsForLocalTraversal =
...
implicit def accessNeighborsForMemberTraversal(traversal: IterableOnce[nodes.Member]): AccessNeighborsForMemberTraversal =
...
implicit def accessNeighborsForMethodParameterInTraversal(traversal: IterableOnce[nodes.MethodParameterIn]): AccessNeighborsForMethodParameterInTraversal =
...
implicit def accessNeighborsForMethodParameterOutTraversal(traversal: IterableOnce[nodes.MethodParameterOut]): AccessNeighborsForMethodParameterOutTraversal =
...
implicit def accessNeighborsForMethodRefTraversal(traversal: IterableOnce[nodes.MethodRef]): AccessNeighborsForMethodRefTraversal =
...
implicit def accessNeighborsForMethodReturnTraversal(traversal: IterableOnce[nodes.MethodReturn]): AccessNeighborsForMethodReturnTraversal =
...
implicit def accessNeighborsForModifierTraversal(traversal: IterableOnce[nodes.Modifier]): AccessNeighborsForModifierTraversal =
...
implicit def accessNeighborsForNamespaceTraversal(traversal: IterableOnce[nodes.Namespace]): AccessNeighborsForNamespaceTraversal =
...
implicit def accessNeighborsForNamespaceBlockTraversal(traversal: IterableOnce[nodes.NamespaceBlock]): AccessNeighborsForNamespaceBlockTraversal =
...
implicit def accessNeighborsForReturnTraversal(traversal: IterableOnce[nodes.Return]): AccessNeighborsForReturnTraversal =
...
implicit def accessNeighborsForTemplateDomTraversal(traversal: IterableOnce[nodes.TemplateDom]): AccessNeighborsForTemplateDomTraversal =
...
implicit def accessNeighborsForTypeArgumentTraversal(traversal: IterableOnce[nodes.TypeArgument]): AccessNeighborsForTypeArgumentTraversal =
...
implicit def accessNeighborsForTypeDeclTraversal(traversal: IterableOnce[nodes.TypeDecl]): AccessNeighborsForTypeDeclTraversal =
...
implicit def accessNeighborsForTypeParameterTraversal(traversal: IterableOnce[nodes.TypeParameter]): AccessNeighborsForTypeParameterTraversal =
...
implicit def accessNeighborsForTypeRefTraversal(traversal: IterableOnce[nodes.TypeRef]): AccessNeighborsForTypeRefTraversal =
...
implicit def accessNeighborsForUnknownTraversal(traversal: IterableOnce[nodes.Unknown]): AccessNeighborsForUnknownTraversal =
...
implicit def accessNeighborsForCfgNodeTraversal(traversal: IterableOnce[nodes.CfgNode]): AccessNeighborsForCfgNodeTraversal =
...
implicit def accessNeighborsForExpressionTraversal(traversal: IterableOnce[nodes.Expression]): AccessNeighborsForExpressionTraversal =
