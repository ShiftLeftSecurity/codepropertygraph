...
def methodParameterOutViaEvalTypeIn: Iterator[nodes.MethodParameterOut] = evalTypeIn.collectAll[nodes.MethodParameterOut]
 ...
 * Traverse to TYPE_DECL via ALIAS_OF IN edge. */
 ...
 * Traverse to TYPE_DECL via REF OUT edge. */
