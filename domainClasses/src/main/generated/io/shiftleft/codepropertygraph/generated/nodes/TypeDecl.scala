...
class TypeDecl(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  @deprecated("please use `aliasedType`", "June 2024")
  def _aliasedType = aliasedType
  ...
  /** Traverse to BINDING via BINDS OUT edge.
    */
  def bindingViaBindsOut: overflowdb.traversal.Traversal[Binding] = get().bindingViaBindsOut

  @deprecated("please use `bindingViaBindsOut`", "June 2024")
  def _bindingViaBindsOut = bindingViaBindsOut
  ...
  /** Traverse to TYPE via INHERITS_FROM OUT edge.
    */
  def typeViaInheritsFromOut: overflowdb.traversal.Traversal[Type] = get().typeViaInheritsFromOut

  @deprecated("please use `typeViaInheritsFromOut`", "June 2024")
  def _typeViaInheritsFromOut = typeViaInheritsFromOut
  ...
  /** Traverse to TYPE via REF IN edge.
    */
  def typeViaRefIn: overflowdb.traversal.Traversal[Type] = get().typeViaRefIn

  @deprecated("please use `typeViaRefIn`", "June 2024")
  def _typeViaRefIn = typeViaRefIn
...
class TypeDeclDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with AstNode with TypeDeclBase {
  ...
  def bindingViaBindsOut: overflowdb.traversal.Traversal[Binding] = bindsOut.collectAll[Binding]
  ...
  def typeViaInheritsFromOut: overflowdb.traversal.Traversal[Type] = inheritsFromOut.collectAll[Type]
  ...
  def typeViaRefIn: overflowdb.traversal.Traversal[Type] = refIn.collectAll[Type]
