...
trait TypeDeclEMT extends AnyRef with AstNodeEMT with HasAliasTypeFullNameEMT with HasAstParentFullNameEMT with HasAstParentTypeEMT with HasFilenameEMT with HasFullNameEMT with HasInheritsFromTypeFullNameEMT with HasIsExternalEMT with HasNameEMT
...
object TypeDecl {
  ...
  object PropertyNames {
    val AliasTypeFullName = io.shiftleft.codepropertygraph.generated.PropertyNames.ALIAS_TYPE_FULL_NAME
...
val InheritsFromTypeFullName = io.shiftleft.codepropertygraph.generated.PropertyNames.INHERITS_FROM_TYPE_FULL_NAME
...
class TypeDecl(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 40.toShort , seq_4762) with TypeDeclBase with AstNode with StaticType[TypeDeclEMT] {
