...
class MethodRefDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with MethodRefBase {
  ...
  def refOut: Iterator[Method] = createAdjacentNodeScalaIteratorByOffSet[Method](5)
  ...
  def cfgOut: Iterator[AstNode] = createAdjacentNodeScalaIteratorByOffSet[AstNode](9)
  override def _cfgOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](9)
  ...
  def captureOut: Iterator[ClosureBinding] = createAdjacentNodeScalaIteratorByOffSet[ClosureBinding](10)
  override def _captureOut                 = createAdjacentNodeScalaIteratorByOffSet[StoredNode](10)
