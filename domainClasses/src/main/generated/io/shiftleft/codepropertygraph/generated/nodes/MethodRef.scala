...
class MethodRef(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to CLOSURE_BINDING via CAPTURE OUT edge.
    */
  def closureBindingViaCaptureOut: overflowdb.traversal.Traversal[ClosureBinding] = get().closureBindingViaCaptureOut

  @deprecated("please use `closureBindingViaCaptureOut`", "June 2024")
  def _closureBindingViaCaptureOut = closureBindingViaCaptureOut
  ...
  /** Traverse to METHOD_RETURN via CFG OUT edge.
    */
  def methodReturnViaCfgOut: overflowdb.traversal.Traversal[MethodReturn] = get().methodReturnViaCfgOut
...
class MethodRefDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with MethodRefBase {
  ...
  def closureBindingViaCaptureOut: overflowdb.traversal.Traversal[ClosureBinding] =
  ...
  def methodReturnViaCfgOut: overflowdb.traversal.Traversal[MethodReturn] = cfgOut.collectAll[MethodReturn]
