...
object NewControlStructure {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_ControlStructure_argumentLabel extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_ControlStructure_offset extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_ControlStructure_offsetEnd extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewControlStructure extends NewNode(nodeKind = 11) with ControlStructureBase with ExpressionNew {
  ...
  override def productElement(n: Int): Any =
    n match {
      ...
      case 5  => this.controlStructureType
