...
class ArrayInitializerDb(ref: NodeRef[NodeDb])
  ...
  def astOut: Iterator[Literal] = createAdjacentNodeScalaIteratorByOffSet[Literal](2)
  ...
  def astIn: Iterator[AstNode] = createAdjacentNodeScalaIteratorByOffSet[AstNode](5)
