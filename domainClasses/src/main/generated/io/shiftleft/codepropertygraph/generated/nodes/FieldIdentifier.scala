...
class FieldIdentifierDb(ref: NodeRef[NodeDb])
  ...
  def argumentOut: Iterator[TemplateDom] = createAdjacentNodeScalaIteratorByOffSet[TemplateDom](3)
  override def _argumentOut              = createAdjacentNodeScalaIteratorByOffSet[StoredNode](3)

  def cdgOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](4)
  override def _cdgOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](4)
  ...
  def cfgOut: Iterator[AstNode] = createAdjacentNodeScalaIteratorByOffSet[AstNode](5)
  ...
  def argumentIn: Iterator[Call] = createAdjacentNodeScalaIteratorByOffSet[Call](11)
