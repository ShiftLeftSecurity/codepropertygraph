...
class FieldIdentifierDb(ref: NodeRef[NodeDb])
  ...
  def pointsToIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](14)
  override def _pointsToIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](14)

  def argumentIn: Iterator[Call] = createAdjacentNodeScalaIteratorByOffSet[Call](15)
