...
class CallDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with CallRepr with CallBase {
  ...
  def dominateOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](1)
  override def _dominateOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](1)
  ...
  def refOut: Iterator[Member]                                 = createAdjacentNodeScalaIteratorByOffSet[Member](4)
  ...
  def receiverOut: Iterator[Expression]   = createAdjacentNodeScalaIteratorByOffSet[Expression](5)
  override def _receiverOut               = createAdjacentNodeScalaIteratorByOffSet[StoredNode](5)
  ...
  def astOut: Iterator[Expression]                           = createAdjacentNodeScalaIteratorByOffSet[Expression](7)
  override def _astOut                                       = createAdjacentNodeScalaIteratorByOffSet[StoredNode](7)
  ...
  def isCallForImportOut: Iterator[Import] = createAdjacentNodeScalaIteratorByOffSet[Import](8)
  override def _isCallForImportOut         = createAdjacentNodeScalaIteratorByOffSet[StoredNode](8)
  def _importViaIsCallForImportOut: overflowdb.traversal.Traversal[Import] = isCallForImportOut.collectAll[Import]

  def callOut: Iterator[Method]                                 = createAdjacentNodeScalaIteratorByOffSet[Method](9)
  override def _callOut                                         = createAdjacentNodeScalaIteratorByOffSet[StoredNode](9)
  def _methodViaCallOut: overflowdb.traversal.Traversal[Method] = callOut.collectAll[Method]

  def reachingDefOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](10)
  override def _reachingDefOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](10)
  ...
  def pointsToOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](11)
  override def _pointsToOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](11)

  def argumentOut: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](12)
  override def _argumentOut          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](12)
  def _fieldIdentifierViaArgumentOut: overflowdb.traversal.Traversal[FieldIdentifier] =
  ...
  def taggedByOut: Iterator[Tag]                              = createAdjacentNodeScalaIteratorByOffSet[Tag](13)
  override def _taggedByOut                                   = createAdjacentNodeScalaIteratorByOffSet[StoredNode](13)
  ...
  def reachingDefIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](16)
  ...
  def receiverIn: Iterator[Call]       = createAdjacentNodeScalaIteratorByOffSet[Call](17)
  override def _receiverIn             = createAdjacentNodeScalaIteratorByOffSet[StoredNode](17)
  ...
  def postDominateIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](21)
  override def _postDominateIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](21)
  ...
  def containsIn: Iterator[Method] = createAdjacentNodeScalaIteratorByOffSet[Method](22)
  override def _containsIn         = createAdjacentNodeScalaIteratorByOffSet[StoredNode](22)
  def _methodViaContainsIn: overflowdb.traversal.Traversal[Method] = containsIn.collectAll[Method]

  def pointsToIn: Iterator[CfgNode] = createAdjacentNodeScalaIteratorByOffSet[CfgNode](23)
  override def _pointsToIn          = createAdjacentNodeScalaIteratorByOffSet[StoredNode](23)

  def argumentIn: Iterator[Expression]     = createAdjacentNodeScalaIteratorByOffSet[Expression](24)
  override def _argumentIn                 = createAdjacentNodeScalaIteratorByOffSet[StoredNode](24)
