...
class Call(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
  ...
  /** Traverse to BLOCK via ARGUMENT OUT edge.
    */
  def blockViaArgumentOut: overflowdb.traversal.Traversal[Block] = get().blockViaArgumentOut
  ...
  /** Traverse to CALL via ARGUMENT OUT edge.
    */
  def callViaArgumentOut: overflowdb.traversal.Traversal[Call] = get().callViaArgumentOut
  ...
  /** Traverse to FIELD_IDENTIFIER via ARGUMENT OUT edge.
    */
  def fieldIdentifierViaArgumentOut: overflowdb.traversal.Traversal[FieldIdentifier] =
    get().fieldIdentifierViaArgumentOut

  @deprecated("please use `fieldIdentifierViaArgumentOut`", "June 2024")
  def _fieldIdentifierViaArgumentOut = fieldIdentifierViaArgumentOut

  /** Traverse to IDENTIFIER via ARGUMENT OUT edge.
    */
  def identifierViaArgumentOut: overflowdb.traversal.Traversal[Identifier] = get().identifierViaArgumentOut
  ...
  /** Traverse to LITERAL via ARGUMENT OUT edge.
    */
  def literalViaArgumentOut: overflowdb.traversal.Traversal[Literal] = get().literalViaArgumentOut
  ...
  /** Traverse to METHOD_REF via ARGUMENT OUT edge.
    */
  def methodRefViaArgumentOut: overflowdb.traversal.Traversal[MethodRef] = get().methodRefViaArgumentOut
  ...
  /** Traverse to METHOD via CALL OUT edge.
    */
  def methodViaCallOut: overflowdb.traversal.Traversal[Method] = get().methodViaCallOut

  @deprecated("please use `methodViaCallOut`", "June 2024")
  def _methodViaCallOut = methodViaCallOut
  ...
  /** Traverse to IMPORT via IS_CALL_FOR_IMPORT OUT edge.
    */
  def importViaIsCallForImportOut: overflowdb.traversal.Traversal[Import] = get().importViaIsCallForImportOut

  @deprecated("please use `importViaIsCallForImportOut`", "June 2024")
  def _importViaIsCallForImportOut = importViaIsCallForImportOut
  ...
  /** Traverse to BLOCK via RECEIVER OUT edge.
    */
  def blockViaReceiverOut: Option[Block] = get().blockViaReceiverOut

  @deprecated("please use `blockViaReceiverOut`", "June 2024")
  def _blockViaReceiverOut = blockViaReceiverOut

  /** Traverse to CALL via RECEIVER OUT edge.
    */
  def callViaReceiverOut: Option[Call] = get().callViaReceiverOut

  @deprecated("please use `callViaReceiverOut`", "June 2024")
  def _callViaReceiverOut = callViaReceiverOut

  /** Traverse to CONTROL_STRUCTURE via RECEIVER OUT edge.
    */
  def controlStructureViaReceiverOut: overflowdb.traversal.Traversal[ControlStructure] =
    get().controlStructureViaReceiverOut

  @deprecated("please use `controlStructureViaReceiverOut`", "June 2024")
  def _controlStructureViaReceiverOut = controlStructureViaReceiverOut

  /** Traverse to IDENTIFIER via RECEIVER OUT edge.
    */
  def identifierViaReceiverOut: Option[Identifier] = get().identifierViaReceiverOut

  @deprecated("please use `identifierViaReceiverOut`", "June 2024")
  def _identifierViaReceiverOut = identifierViaReceiverOut

  /** Traverse to LITERAL via RECEIVER OUT edge.
    */
  def literalViaReceiverOut: Option[Literal] = get().literalViaReceiverOut

  @deprecated("please use `literalViaReceiverOut`", "June 2024")
  def _literalViaReceiverOut = literalViaReceiverOut

  /** Traverse to METHOD_REF via RECEIVER OUT edge.
    */
  def methodRefViaReceiverOut: Option[MethodRef] = get().methodRefViaReceiverOut

  @deprecated("please use `methodRefViaReceiverOut`", "June 2024")
  def _methodRefViaReceiverOut = methodRefViaReceiverOut

  /** Traverse to TYPE_REF via RECEIVER OUT edge.
    */
  def typeRefViaReceiverOut: overflowdb.traversal.Traversal[TypeRef] = get().typeRefViaReceiverOut

  @deprecated("please use `typeRefViaReceiverOut`", "June 2024")
  def _typeRefViaReceiverOut = typeRefViaReceiverOut

  /** Traverse to UNKNOWN via RECEIVER OUT edge.
    */
  def unknownViaReceiverOut: overflowdb.traversal.Traversal[Unknown] = get().unknownViaReceiverOut

  @deprecated("please use `unknownViaReceiverOut`", "June 2024")
  def _unknownViaReceiverOut = unknownViaReceiverOut
  ...
  /** Traverse to CALL via ARGUMENT IN edge.
    */
  def callViaArgumentIn: Option[Call] = get().callViaArgumentIn
  ...
  /** Traverse to CONTROL_STRUCTURE via AST IN edge.
    */
  def controlStructureViaAstIn: ControlStructure = get().controlStructureViaAstIn
  ...
  /** Traverse to CALL via RECEIVER IN edge.
    */
  def callViaReceiverIn: Option[Call] = get().callViaReceiverIn
...
class CallDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with CallRepr with Expression with CallBase {
  ...
  def blockViaArgumentOut: overflowdb.traversal.Traversal[Block] = argumentOut.collectAll[Block]
  @deprecated("please use `callViaArgumentOut`", "June 2024")
  def _callViaArgumentOut = callViaArgumentOut

  def callViaArgumentOut: overflowdb.traversal.Traversal[Call] = argumentOut.collectAll[Call]
  @deprecated("please use `controlStructureViaArgumentOut`", "June 2024")
  def _controlStructureViaArgumentOut = controlStructureViaArgumentOut
  ...
  def identifierViaArgumentOut: overflowdb.traversal.Traversal[Identifier] = argumentOut.collectAll[Identifier]
  @deprecated("please use `jumpTargetViaArgumentOut`", "June 2024")
  def _jumpTargetViaArgumentOut = jumpTargetViaArgumentOut
  ...
  def literalViaArgumentOut: overflowdb.traversal.Traversal[Literal] = argumentOut.collectAll[Literal]
  @deprecated("please use `methodRefViaArgumentOut`", "June 2024")
  def _methodRefViaArgumentOut = methodRefViaArgumentOut

  def methodRefViaArgumentOut: overflowdb.traversal.Traversal[MethodRef] = argumentOut.collectAll[MethodRef]
  @deprecated("please use `typeRefViaArgumentOut`", "June 2024")
  def _typeRefViaArgumentOut = typeRefViaArgumentOut
  ...
  def methodViaCallOut: overflowdb.traversal.Traversal[Method] = callOut.collectAll[Method]
  ...
  def importViaIsCallForImportOut: overflowdb.traversal.Traversal[Import] = isCallForImportOut.collectAll[Import]
  ...
  def blockViaReceiverOut: Option[Block] = receiverOut.collectAll[Block].nextOption()
  @deprecated("please use `callViaReceiverOut`", "June 2024")
  def _callViaReceiverOut = callViaReceiverOut

  def callViaReceiverOut: Option[Call] = receiverOut.collectAll[Call].nextOption()
  @deprecated("please use `controlStructureViaReceiverOut`", "June 2024")
  def _controlStructureViaReceiverOut = controlStructureViaReceiverOut
  ...
  def identifierViaReceiverOut: Option[Identifier] = receiverOut.collectAll[Identifier].nextOption()
  @deprecated("please use `literalViaReceiverOut`", "June 2024")
  def _literalViaReceiverOut = literalViaReceiverOut

  def literalViaReceiverOut: Option[Literal] = receiverOut.collectAll[Literal].nextOption()
  @deprecated("please use `methodRefViaReceiverOut`", "June 2024")
  def _methodRefViaReceiverOut = methodRefViaReceiverOut

  def methodRefViaReceiverOut: Option[MethodRef] = receiverOut.collectAll[MethodRef].nextOption()
  @deprecated("please use `typeRefViaReceiverOut`", "June 2024")
  def _typeRefViaReceiverOut = typeRefViaReceiverOut

  def typeRefViaReceiverOut: overflowdb.traversal.Traversal[TypeRef] = receiverOut.collectAll[TypeRef]
  @deprecated("please use `unknownViaReceiverOut`", "June 2024")
  def _unknownViaReceiverOut = unknownViaReceiverOut

  def unknownViaReceiverOut: overflowdb.traversal.Traversal[Unknown] = receiverOut.collectAll[Unknown]
  ...
  def callViaArgumentIn: Option[Call] = argumentIn.collectAll[Call].nextOption()
  @deprecated("please use `returnViaArgumentIn`", "June 2024")
  def _returnViaArgumentIn = returnViaArgumentIn
  ...
  def controlStructureViaAstIn: ControlStructure = try { astIn.collectAll[ControlStructure].next() }
  catch {
  ...
  def callViaReceiverIn: Option[Call] = receiverIn.collectAll[Call].nextOption()
