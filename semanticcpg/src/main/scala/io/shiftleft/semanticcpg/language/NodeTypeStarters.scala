...
class NodeTypeStarters(cpg: Cpg) {
  ...
  /**
    ...
    * */
  def comment(code: String): Comment[nodes.Comment] = comment.code(code)

  /**
    Traverse to all source files
    */
  def file: File[nodes.File] =
    new File(scalaGraph.V.hasLabel(NodeTypes.FILE).cast[nodes.File])

  /**
    * Shorthand for `cpg.file.name(name)`
    * */
  def file(name: String): File[nodes.File] =
    file.name(name)
  ...
  /**
    ...
    * */
  def namespace(name: String): Namespace[nodes.Namespace] =
    namespace.name(name)
  ...
  /**
    ...
    * */
  def typeDecl(fullName: String): TypeDecl[nodes.TypeDecl] =
  ...
  /**
    ...
    * */
  def method(fullName: String): Method[nodes.Method] =
  ...
  /**
    ...
    * */
  def parameter(name: String): MethodParameter[nodes.MethodParameterIn] =
    parameter.name(name)

  /**
    Traverse to all class members
    */
  def member: Member[nodes.Member] =
    new Member(scalaGraph.V.hasLabel(NodeTypes.MEMBER).cast[nodes.Member])

  /**
    * Shorthand for `cpg.member.name(name)`
    * */
  def member(name: String): Member[nodes.Member] =
    member.name(name)
  ...
  /**
    ...
    * */
  def call(name: String): Call[nodes.Call] =
    call.name(name)
  ...
  /**
    ...
    * */
  def local(name: String): Local[nodes.Local] =
    local.name(name)
  ...
  /**
    ...
    * */
  def literal(code: String): Literal[nodes.Literal] =
    literal.code(code)
  ...
  /**
    ...
    * */
  def identifier(name: String): Identifier[nodes.Identifier] =
  ...
  /**
    ...
    * */
  def methodRef(fullName: String): MethodRef[nodes.MethodRef] =
