...
libraryDependencies ++= Seq(
  ...
  "com.michaelpollmeier" %% "gremlin-scala" % "3.4.1.7",
  "com.google.guava" % "guava" % "21.0",
  "org.apache.commons" % "commons-lang3" % "3.5",
  "commons-io" % "commons-io" % "2.5",
  "org.scala-lang.modules" %% "scala-java8-compat" % "0.9.0",
  "com.michaelpollmeier" %% "scala-arm" % "2.1", //TODO back to com.jsuereth once 2.1 is published: see https://github.com/jsuereth/scala-arm/issues/79
