...
/**  */
public static final String assignmentMultiplication = "<operator>.assignmentMuliplication";
...
/** Comparsion between to arguments with the results: 0 == equal, negative == left < right, positive == left > right */
