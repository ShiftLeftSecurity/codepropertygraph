...
// node types
val binding: NodeType = builder.addNodeType(
  name = "BINDING",
...
val implicitCall: NodeType = builder.addNodeType(
  name = "IMPLICIT_CALL",
...
val postExecutionCall: NodeType = builder.addNodeType(
...
val tag: NodeType = builder.addNodeType(
  name = "TAG",
...
val namespace: NodeType = builder.addNodeType(
  name = "NAMESPACE",
...
val methodParameterOut: NodeType = builder.addNodeType(
