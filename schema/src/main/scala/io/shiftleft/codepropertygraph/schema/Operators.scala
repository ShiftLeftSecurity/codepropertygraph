...
// constants
    val operators = builder.addConstants(
      ...
      Constant(name = "arrayInitializer",
               ...
               valueType = ValueTypes.STRING,
               comment = ""),
      Constant(name = "arrayCreator", value = "<operator>.arrayCreator", valueType = ValueTypes.STRING, comment = ""),
      Constant(name = "alloc", value = "<operator>.alloc", valueType = ValueTypes.STRING, comment = ""),
