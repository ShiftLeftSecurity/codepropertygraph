...
val file: NodeType = builder.addNodeType(
  name = "FILE",
...
val method: NodeType = builder.addNodeType(
  name = "METHOD",
...
val methodParameterIn: NodeType = builder.addNodeType(
...
val methodReturn: NodeType = builder.addNodeType(
  name = "METHOD_RETURN",
...
val modifier: NodeType = builder.addNodeType(
  name = "MODIFIER",
...
val tpe: NodeType = builder.addNodeType(
  name = "TYPE",
...
val typeDecl: NodeType = builder.addNodeType(
  name = "TYPE_DECL",
...
val typeParameter: NodeType = builder.addNodeType(
  name = "TYPE_PARAMETER",
...
val member: NodeType = builder.addNodeType(
  name = "MEMBER",
...
val namespaceBlock: NodeType = builder.addNodeType(
...
val callNode: NodeType = builder.addNodeType(
  name = "CALL",
...
val local: NodeType = builder.addNodeType(
  name = "LOCAL",
...
val ret: NodeType = builder.addNodeType(
  name = "RETURN",
...
val methodInst: NodeType = builder.addNodeType(
  name = "METHOD_INST",
...
val arrayInitializer: NodeType = builder.addNodeType(
...
.addOutEdge(edge = receiver, inNode = callNode, cardinalityOut = Cardinality.ZeroOrOne, cardinalityIn = Cardinality.ZeroOrOne)
...
fieldIdentifier
.addOutEdge(edge = cfg, inNode = callNode, cardinalityOut = Cardinality.One, cardinalityIn = Cardinality.ZeroOrOne)
.addOutEdge(edge = cfg, inNode = identifier)
.addOutEdge(edge = cfg, inNode = fieldIdentifier)
.addOutEdge(edge = cfg, inNode = literal)
.addOutEdge(edge = cfg, inNode = methodRef)
...
.addOutEdge(edge = argument, inNode = callNode, cardinalityOut = Cardinality.ZeroOrOne, cardinalityIn = Cardinality.ZeroOrOne)
