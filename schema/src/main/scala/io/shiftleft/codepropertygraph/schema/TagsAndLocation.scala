...
// node tpes
val location: NodeType = builder.addNodeType(
  name = "LOCATION",
  comment = ""
).protoId(25)
...
val tagNodePair: NodeType = builder.addNodeType(
  name = "TAG_NODE_PAIR",
  comment = ""
).protoId(208)
...
val source: NodeType = builder.addNodeType(
  name = "SOURCE",
  comment = ""
).protoId(202)
...
val sink: NodeType = builder.addNodeType(
  name = "SINK",
  comment = ""
).protoId(203)
