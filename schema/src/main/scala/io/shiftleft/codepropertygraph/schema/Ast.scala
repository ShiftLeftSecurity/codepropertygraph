...
object Ast extends SchemaBase {
  ...
  class Schema(builder: SchemaBuilder,
    ...
    method
      .addOutEdge(edge = ast, inNode = methodReturn, cardinalityOut = Cardinality.One, cardinalityIn = Cardinality.One, stepNameOut = "methodReturn", stepNameOutDoc = "Formal return parameters")
