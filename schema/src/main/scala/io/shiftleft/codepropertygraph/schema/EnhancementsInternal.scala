...
val dominate = builder.addEdgeType(
  name = "DOMINATE",
  comment = "Points to dominated node in DOM tree"
).protoId(181)


val postDominate = builder.addEdgeType(
  name = "POST_DOMINATE",
  comment = "Points to dominated node in post DOM tree"
).protoId(182)


val cdg = builder.addEdgeType(
  name = "CDG",
...
val tags: NodeType = builder.addNodeType(
  name = "TAGS",
...
val framework: NodeType = builder.addNodeType(
  name = "FRAMEWORK",
...
val frameworkData: NodeType = builder.addNodeType(
  name = "FRAMEWORK_DATA",
...
val detachedTrackingPoint: NodeType = builder.addNodeType(
