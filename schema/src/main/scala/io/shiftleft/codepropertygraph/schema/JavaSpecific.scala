...
// node types
val annotation: NodeType = builder.addNodeType(
  name = "ANNOTATION",
...
val annotationParameterAssign: NodeType = builder.addNodeType(
...
val annotationParameter: NodeType = builder.addNodeType(
...
val annotationLiteral: NodeType = builder.addNodeType(
...
val configFile: NodeType = builder.addNodeType(
  name = "CONFIG_FILE",
