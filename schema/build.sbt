...
// ThisBuild / Compile / generateDomainClasses / classWithSchema := "io.shiftleft.codepropertygraph.schema.CpgSchema$"
// ThisBuild / Compile / generateDomainClasses / fieldName := "instance"
