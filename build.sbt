...
val overflowdbVersion = "1.140"
val overflowdbCodegenVersion = "2.61+1-4693c49f"
...
ThisBuild / libraryDependencies ++= Seq("org.apache.logging.log4j" % "log4j-slf4j-impl" % "2.17.1" % Test)
