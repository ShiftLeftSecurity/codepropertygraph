...
class OutFactsImporter extends FactsImporter {
  ...
  override def loadFacts: List[OutFact] =
    List(
      ...
      NodeTypes.METHOD has 0 to N outgoing EdgeTypes.AST to NodeTypes.TYPE_DECL,
      ...
      NodeTypes.TYPE_DECL has 0 to N outgoing EdgeTypes.AST to NodeTypes.TYPE_DECL,
      ...
      NodeTypes.CALL has 0 to N outgoing EdgeTypes.AST to SuperTypes.Expression or NodeTypes.CONTROL_STRUCTURE,
      ...
      NodeTypes.CALL has 0 to 1 outgoing EdgeTypes.RECEIVER to
        NodeTypes.CALL or NodeTypes.IDENTIFIER or NodeTypes.LITERAL or NodeTypes.METHOD_REF or NodeTypes.TYPE_REF or NodeTypes.BLOCK,
      ...
      NodeTypes.TYPE_REF has 1 to N outgoing EdgeTypes.CFG to SuperTypes.Expression or NodeTypes.METHOD_RETURN,
      NodeTypes.TYPE_REF has 0 to N outgoing EdgeTypes.CAPTURE to NodeTypes.CLOSURE_BINDING,
